...
package com.fima.cardsui.listener;
...
/**
 * A {@link View.OnTouchListener} that makes any {@link View} dismissable when the user swipes (drags her finger) horizontally across the view.
 * 
 * <p>
...
public class SwipeDismissTouchListener implements View.OnTouchListener {
	 ...
	 * @param onDismissCallback The callback to trigger when the user has indicated that she would like to dismiss this view.
	 */
	public SwipeDismissTouchListener(View view, Object token, OnDismissCallback onDismissCallback) {
