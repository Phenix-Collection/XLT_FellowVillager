...
/**
 列出跟对方聊天过程中产生的卡片
 此Activity是个人对话管理中点击“历史记录”后的界面
 */
@EActivity(R.layout.activity_all_visiting_code)
public class SpecificVisitingCodeActivity extends BaseActivity {

    public static int SHOWEDCARDCOUNT = 3;
    ...
    public void init () {
        ...
        mCardLoader = new CardLoader(this, toChatId, BorrowConstants.CHATTYPE_SINGLE, 0, 0,false, true);
    ...
    private class CardListCallbacks implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        public void onLoadFinished (Loader<Cursor> loader, Cursor data) {
            ...
            if(mMessageBeanList.size() <= SHOWEDCARDCOUNT){
                view_line.setVisibility(View.VISIBLE);
            }else{
                view_line.setVisibility(View.GONE);
            }
            visiting_code_lv.setAdapter(new VisitingCodeAdapter(SpecificVisitingCodeActivity.this, mMessageBeanList, toChatName, true));
