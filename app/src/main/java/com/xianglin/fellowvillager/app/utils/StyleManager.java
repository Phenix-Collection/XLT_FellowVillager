...
public class StyleManager {
	 ...
	 */
	private void init() { 
//		mTypefaceCN = Typeface.createFromAsset(mContext.getAssets(), "paone/assets/css/FZZYJ.ttf");
//		mTypefaceEN = Typeface.createFromAsset(mContext.getAssets(), "paone/assets/css/Gotham-Book.ttf");
	}
...
//				}
//				((EditText) v).setHintTextColor(mContext.getResources().getColor(R.color.textgrey));
//				((EditText) v).setTextColor(mContext.getResources().getColor(R.color.uedgrey));
	...
	public void setStatusBarStyle(Activity activity) {
		...
		if (contentView != null) {
			...
			if (childView != null) {
				...
				//						tintManager.setStatusBarTintResource(R.color.fund_yztb_bg_showcase_color);
				//					}else if("PrivateInvestmentIntroduceActivity".equals(activityName)){
				//						tintManager.setStatusBarTintResource(R.color.privateInvestmentIntroduceActivity_mainlayout_start);
				//					}else{
 ...
 /*		    SystemBarTintManager tintManager = new SystemBarTintManager(activity);
	...
	public static int getStatusBarHeight(Context context){
		...
		try {
			...
			if(statusBarHeight<=0){
				statusBarHeight=DeviceInfoUtil.dip2px(25);//默认高度
			}
		}
