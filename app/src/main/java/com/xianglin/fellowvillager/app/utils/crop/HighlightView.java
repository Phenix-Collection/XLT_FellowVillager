...
class HighlightView {
    ...
    private static final int DEFAULT_HIGHLIGHT_COLOR = 0xFF30b3a9;
    ...
    protected void draw(Canvas canvas) {
        ...
        if (!hasFocus()) {
            ...
            if (isClipPathSupported(canvas)) {
             ...
             //   canvas.drawRect(viewDrawingRect, outsidePaint); 遮罩层
            } else {
          ...
          //  canvas.drawPath(path, outlinePaint);
            ...
            if (showCircle) {
                //drawCircle(canvas);
                canvas.drawCircle(drawRect.centerX(),drawRect.centerY(),drawRect.height()/2,outlinePaint);
            }
