...
import com.xianglin.fellowvillager.app.animation.DefaultAnimationHandler;
import com.xianglin.fellowvillager.app.animation.MenuAnimationHandler;
...
public class FloatingActionMenu {
    ...
    /**
     * Constructor that takes the paracmeters collected using {@link FloatingActionMenu.Builder}
...
//            return ((Activity) mainActionView.getContext()).getWindow().getDecorView().findViewById(android.R.id.content);
            View view = ((Activity) mainActionView.getContext()).getWindow().getDecorView().findViewById(android.R.id.content);
    ...
    public static class Builder {
        ...
        public Builder(Context context, boolean systemOverlay) {
            ...
            // Default settings
            radius = context.getResources().getDimensionPixelSize(R.dimen.dimen_96_dip);
            startAngle = 180;
            endAngle = 270;
        ...
        /**
         * 添加一组view
         * @param subActionViews
         * @return
         */
        public Builder addSubActionView(List<View> subActionViews) {
            if(systemOverlay) {
                throw new RuntimeException("Sub action views cannot be added without " +
                        "definite width and height. Please use " +
                        "other methods named addSubActionView");
