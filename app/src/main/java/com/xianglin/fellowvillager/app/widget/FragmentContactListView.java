...
public class FragmentContactListView extends ListView {
	...
	public FragmentContactListView(Context context) {
		this(context, null);
	}

	public FragmentContactListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public FragmentContactListView(Context context, AttributeSet attrs, int defStyle) {
