...
public class TopView extends RelativeLayout {
    ...
    private void initview(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (isInEditMode()) {
            ...
            textView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, getResources().getDimensionPixelSize
   ...
   /*         topView.setLayoutParams(new RelativeLayout.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT, StyleManager.statusBarHeight + getResources()
...
*/
    ...
    private void initView() {
        ...
        rightLayout1 = (LinearLayout) layout.findViewById(R.id.ll_right_layout_1);
    }
        ...
        backLayout.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mContext instanceof Activity) {
                    ...
                    ((BaseActivity)mContext).animRightToLeft();
                }
            }
        });
    }
     ...
     * 设置右边图片的显示状态
     */
    public void setRightImage1Visibility(int visibility) {
        rightLayout1.setVisibility(visibility);
    }
    ...
    public void setRightImageDrawable(int id) {
        isRightTextViewShow(false);
//        if (id == R.drawable.icon_add) {
//            rightLayout.setBackgroundColor(R.color.app_title_bg);
//        }
