...
package com.xianglin.fellowvillager.app.widget.swipelistview;
...
/*        if (swipeFrontView == 0 || swipeBackView == 0) {
        ...
        touchListener.setRightOffset(swipeOffsetRight);
         ...
         //// TODO: 2016/3/24  临时方案
         LogCatLog.e(TAG,"setLeftOffset 有个临时解决方案,固定偏移距离了");

         float offset= DeviceInfoUtil.getWidth(getContext())-DeviceInfoUtil.dip2px(100);

         touchListener.setLeftOffset(offset);
